...
st.text("Fever, Severe Headache, Diarhea, Fatigue, Nausea and Vomiting, Muscle Pain, Chills, Addominal Pain")
...
st.text("Blurred vision, Swollen feet hands and Face, Difficulty urinating, Pain below the ribs")
# st.text("Swollen feet hands and Face")
# st.text("Difficulty urinating")
# st.text("Pain below the ribs")
st.text("Heartburn, Repid heartbeat, Vaginal Bleeding at 20 weeks, Abdominal cramps, Back Pain")
